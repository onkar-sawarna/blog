...
<figure>
  ...
  <figcaption>Figure 2. The API talks to the proxy. The database only sees the proxy's pool.</figcaption>
</figure>
...
<figure>
  ...
  <figcaption>Figure 3. One address in the app. The list of real servers stays behind the proxy.</figcaption>
</figure>
...
<figure>
  ...
  <figcaption>Figure 4. Same SQL. The question is who owns the map.</figcaption>
</figure>
...
<figure>
  ...
  <figcaption>Figure 5. Only the routing rules changed. Catalog and checkout still see one host.</figcaption>
</figure>
...
<figure>
  ...
  <figcaption>Figure 8. Scale the proxy. Keep one budget on the database.</figcaption>
</figure>
